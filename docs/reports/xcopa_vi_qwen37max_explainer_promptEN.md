...
|---|---|---|---|---|---|---|
| `(root)` | 100 | 96.0% | 1.0% | 0.950 | 95.0% | 4.65 |
...
- Questions where the counterfactual flipped the prediction at least once: **95/100**
...
### `(root)` — 4 incorrect predictions

- Genuinely picked the wrong option: **3**
